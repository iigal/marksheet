...
--
-- Host: localhost
-- Generation Time: Feb 24, 2011 at 09:28 AM
...
(1, 2011, 'Nursary', 'B', '000-0001'),
(2, 2012, 'one', 'A', '000-0001'),
(4, 2011, 'oneB', 'B', '000-0004'),
(5, 2011, 'two', 'B', '002-1000'),
(6, 2012, 'nursary', 'B', '000-0000'),
(7, 2012, 'one', 'B', '000-0002'),
(8, 2011, 'one', 'C', '');
...
(6, 'erre', 'er', '', 0, '', '0000-00-00', 'male', 'er', 23, 231, 'sad@sa.cd', 0),
(7, 'fsda', 'fdsa', '', 0, '', '0000-00-00', 'male', 'dfd', 3213, 23, 'dsa@ad.cs', 0),
(8, 'fsd', 'fds', '', 0, '', '0000-00-00', 'male', 'fds', 43, 34, 'fsd@ad.cs', 0),
...
(13, 'raju', 'kattel', '002-0000', 5, 'r5', '1986-05-05', 'Male', 'ktl', 333, 3332, 'sgdsg@gdhf', 2012);
...
(4, '001-0000', 'maths', 80, 20, 100, 'final term', 2012),
