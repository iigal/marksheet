...
?>		<div id="search_form" align="center">
		<form action="?page=marks__individual_view&action=search_marks" method="post" />
        <table >
            <tr>
			...
			<tr id="examtype_ajax">
             ...
             <tr>
                <td>Student ID</td>
                <td><input type="text" name="sid1" id="textbox"  value="<?php echo $_SESSION['admin']; ?>" readonly="readonly"/> </td>
            </tr>
...
?>
        ...
        <form action="?page=marks__individual_view" method="post" />
        <?php
            //sql for extracting data from two tables subject and marks_2012
            $sql= "select * from subject S , marks_2012 M where M.ClassID='".$classid1."' and M.SID='".$sid1."' and M.ExamType='".$exam_type1."' and M.Year='".$year1."' and S.ClassID=M.ClassID and S.Year=M.Year and S.ExamType=M.ExamType and S.Subject=M.Subject";
